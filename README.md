...
- [📸 Media Renamer - EXIF-Based Photo & Video Organizer](#-media-renamer-exif-based-photo-video-organizer)
   ...
   * [🧪 Example of use with the `sandbox` directory](#-example-of-use-with-the-sandbox-directory)
      ...
      + [▶️ Example 1: Renaming generic photos](#-example-1-renaming-generic-photos)
      + [▶️ Example 2: renaming photos with a WhatsApp-style prefix](#-example-2-renaming-photos-with-a-whatsapp-style-prefix)

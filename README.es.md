...
- [📸 Media Renamer: organizador de fotos y vídeos basado en EXIF](#-media-renamer-organizador-de-fotos-y-vídeos-basado-en-exif)
   ...
   * [🧪 Ejemplo de uso con el directorio `sandbox`](#-ejemplo-de-uso-con-el-directorio-sandbox)
      ...
      + [▶️ Ejemplo 1: renombrar fotos genéricas](#-ejemplo-1-renombrar-fotos-genéricas)
      + [▶️ Ejemplo 2: renombrar fotos con prefijo estilo WhatsApp](#-ejemplo-2-renombrar-fotos-con-prefijo-estilo-whatsapp)
...
El parámetro **extensions** controla qué tipos de archivos se procesan. De forma predeterminada, el script maneja formatos de foto comunes (JPG, JPEG, PNG, HEIC) y formatos de vídeo (MP4, MOV, 3GP), además de MPO para panorámicas:
